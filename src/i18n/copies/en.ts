export const en = {
  ...
  blogBtn: 'Read more',
  cardTitle1:
    'Good Faith within the framework of the Civil Code of Quebec',
  descriptionCard1:
  ...
  fullDescription_2_Title2: 'Prejudice: Second Keystone',
  ...
  fullDescription_3_Title1: 'What is Prescription in Personal Law?',
  ...
  fullDescription_5_Text1:
    'Civil Law encompasses a set of rules and principles that govern relationships between individuals and ensure justice and fairness in these interactions. It covers a wide range of areas, including contracts, civil liability, litigation, and inheritance.',
  fullDescription_5_Title2:
    'Legal Services in Civil Law with 1-855 MASTERS',
