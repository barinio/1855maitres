...
export const dataBlog = [
  ...
  },
  {
    ...
    img: img4,
    description:
      "Protect your rights, adapt legal solutions with expertise and care. Need a lawyer? The legal world can often seem complex and intimidating, but with 1-855-MAÎTRES at your side, you can rest assured that your interests will be expertly defended. Founded in 2021 by Maître Sophie Mongeon, 1-855-MAÎTRES is much more than a simple legal service – it is a partner in defending your rights and resolving your legal problems.",
    fullDescription: [
      {
        title: "Tailor-made legal solutions",
        text: "Our team of highly qualified lawyers offers tailor-made legal solutions in various areas to meet your specific needs. Whether you are facing civil law, insurance law, criminal and penal law, or labor and social law issues, we have the expertise to guide you through every step of the process.                           1.Civil Law: Our civil law attorneys are prepared to develop legal solutions tailored to your needs, providing you with effective and ethical representation in all civil matters. 2.Insurance Law: If your insurance companies refuse to pay you, we are here to assert your rights. Our team will help you obtain the compensation to which you are entitled. 3.Criminal and Penal Law: When faced with justice, you are not alone. Benefit from the recognized expertise of our lawyers in criminal and penal law to ensure a solid defense. 4.Labor and Social Law: Whatever your needs in the labor and social field, our tailor-made legal solutions will guide and support you."
      },
      {
        title: "The Democratization of Law",
        text: "1-855-MAÎTRES represents the democratization of law by guaranteeing rapid and affordable access to competent and knowledgeable experts. Our lawyers respect strict criteria of efficiency, ethics, commitment, fairness and transparency, thus ensuring quality legal representation."
      },
      {
        title: "Your Legal Partner in Quebec",
        text: "1-855-MAÎTRES is the legal service in Quebec dedicated to providing comprehensive and accessible legal services. Regardless of the nature of your legal situation, we work tirelessly to defend your rights and interests. Our consultations are affordable because we believe in providing legal advice that is accessible to everyone. If you are looking for a solution to your legal problems, contact us without delay at 1-855-MAÎTRES . Our office is located at 4350 Rue Beaubien E, Montreal, QC H1T 1S9 . Take the first step toward resolving your legal issues with the expert assistance of 1-855-MAÎTRES."
      }
    ]
  },
  {
    ...
    fullDescription: [
      {
        ...
        text: "Civil Law encompasses a set of rules and principles that govern relationships between individuals and ensure justice and fairness in these interactions. It covers a wide range of areas, including contracts, civil liability, litigation, and inheritance."
      },
      {
